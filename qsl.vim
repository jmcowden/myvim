...
syn match qslAttr "\<gryphon\>\.\(visa\|os\|browser\|cookie_id\|cookied\|perc_skipped\|num_skipped\|num_asked\|ip\|interview_type\)\+" contained
...
" functions
syn keyword qslFunc random assign_treatment best_match bottom_n counter_increment counter_value date Decimal Dict fuzzy_matcher contained
